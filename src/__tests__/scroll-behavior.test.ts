...
describe('ScrollAwareNav - Scroll Behavior', () => {
  ...
  beforeEach(() => {
    ...
    Object.defineProperty(document.documentElement, 'clientHeight', { value: 1024, writable: true });
  ...
  describe('Bottom of Page Behavior', () => {
    it('should show navigation at bottom of page when showAtBottom is true', async () => {
      ...
      Object.defineProperty(window, 'pageYOffset', { value: scrollHeight - viewportHeight, writable: true });
